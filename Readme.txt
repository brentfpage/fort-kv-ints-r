fort-kv-ints is an add-on to LEOPARD that partially computes the nonlinear growth rate of the weak turbulence theory for parallel-propagating electromagnetic waves in magnetized plasma.
...
Some details of the computation can be found in @@.
...
File descriptions:
    The following files in /fort_kv_ints_r are revised versions of files from LEOPARD
        ...
        Descriptions of modifications:
            ...
            -- /distribution/distribution1.dat in /fort_kv_ints_r is an electron vdf derived from measurements by the ARTEMIS electrostatic analyzer during a whistler wave event.  For details, see @@.
...
Contact:
    Questions about fort-kv-ints can be directed to brentfpage@gmail.com .  More details about LEOPARD can be found in www.github.com/pastfalk/LEOPARD .  
